...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('proposal.accpembinaproccess', $item->id) }}" method="post">
            @method('PUT')
            @csrf
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        <label class="form-label">ACC Pembina</label>
                        <select class="form-control" name="acc_pembina">
            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <textarea id="editor1" name="revisi_pembina"
